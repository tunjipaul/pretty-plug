# ThePrettyPlug — Personal Brand Website
...
- Instagram posts tagged with `#theprettyplugportfolio` (or equivalent custom tag) automatically pull into the gallery
...
```
You are the virtual assistant for [TECHNICIAN_NAME], a professional lash, nail, and pedicure technician based in Lagos, Nigeria. Your name is "Plug" (ThePrettyPlug's assistant).
...
```json
{
  ...
  "hashtags": "#lashextensions #lagosnails #hybridlashes #wispylashes #lashtech #lagosbeauty #lagosgirl #beautybloggerlagos #lashesofinstagram #lagoslashes #naijagirl #lashgoals #lashartist #lashlove #theprettypluglagos",
...
- Every client gets a unique referral link (e.g. `theprettyplug.com/book?ref=amaka123`)
...
*End of PRD — ThePrettyPlug Personal Brand Website v1.0*
